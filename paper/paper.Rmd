...
- **shiny app**: An interactive `shiny` web app to visualise the effect of selecting different weight threshold for substituting the wages data to its predicted value from a fit of the robust linear regression model. This app could be accessed [here](https://ebsmonash.shinyapps.io/yowie_app/) with the source code provided [here](https://github.com/numbats/yowie/tree/master/app).
