...
The goal of yowie is to provide longitudinal wages data sets along with several demographic variables from The National Longitudinal Survey of Youth (NLSY) from survey year 1979 to 2018. There are three data sets in this package:
